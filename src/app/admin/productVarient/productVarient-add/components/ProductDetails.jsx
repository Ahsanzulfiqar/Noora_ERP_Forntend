...
const ProductDetails = ({ values }) => {
  ...
  console.log('ProductDetails variant details', values);
        ...
        <div className="mt-3">
          ...
          {(values?.product || values?.sku) && (
            <div className="fs-16 mt-1 d-flex gap-1 flex-column">
              {values?.product && <span className='fw-bold text-dark'>Product Name: {values?.product}</span>}
          ...
          <h4 className="fw-semibold text-dark mt-2 d-flex align-items-center gap-1">
            <span>pack Size:</span>
            <span className=' text-dark fs-14 py-1 px-2 fw-bold'>{values?.packSize || '0.00'}</span>
          </h4>          <h4 className="fw-semibold text-dark mt-2 d-flex align-items-center gap-1">
            <span>Net Weight:</span>
            <span className=' text-dark fs-14 py-1 px-2 fw-bold'>{values?.netWeight || '0.00'}</span>
          </h4>
